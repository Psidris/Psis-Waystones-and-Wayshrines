...
public class ModAdvancementsSubProvider implements AdvancementSubProvider {
	...
	public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> advancements) {
		...
		AdvancementHolder find_amethyst_geode = Advancement.Builder.advancement()
				.parent(root)
		...
		AdvancementHolder find_quartz = Advancement.Builder.advancement()
				.parent(root)
		...
		AdvancementHolder craft_waystone_core = Advancement.Builder.advancement()
