...
public class BlockInit {
	...
	public static final RegistryObject<ResonanceCrystalBlock> RESONANCE_CRYSTAL_BLOCK = register("resonance_crystal_block",
	...
	public static final RegistryObject<BuddingResonanceCrystalBlock> BUDDING_RESONANCE_CRYSTAL = register("budding_resonance_crystal",
	...
	public static final RegistryObject<ResonanceCrystalClusterBlock> RESONANCE_CRYSTAL_CLUSTER = register("resonance_crystal_cluster",
	...
	public static final RegistryObject<ResonanceCrystalClusterBlock> LARGE_RESONANCE_CRYSTAL_BUD = register("large_resonance_crystal_bud",
			() -> new ResonanceCrystalClusterBlock(5, 3, BlockBehaviour.Properties.copy(RESONANCE_CRYSTAL_CLUSTER.get())));
	public static final RegistryObject<ResonanceCrystalClusterBlock> MEDIUM_RESONANCE_CRYSTAL_BUD = register("medium_resonance_crystal_bud",
			() -> new ResonanceCrystalClusterBlock(4, 3, BlockBehaviour.Properties.copy(RESONANCE_CRYSTAL_CLUSTER.get())));
	public static final RegistryObject<ResonanceCrystalClusterBlock> SMALL_RESONANCE_CRYSTAL_BUD = register("small_resonance_crystal_bud",
